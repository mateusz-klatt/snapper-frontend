          ...
          >
            ...
            {onRestart && (showStopButton || (managedRemotely === true && autoStartEnabled)) && (
              <button
                ...
                className='flex-1 px-4 py-2 rounded-md text-sm font-medium bg-info-600 text-info-50 transition-colors hover:bg-info-700 focus:outline-none focus:ring-2 focus:ring-info-500 disabled:opacity-50 disabled:cursor-not-allowed'
              >
                {isRestarting ? (
                  <>
                    <LoadingSpinner size='sm' className='inline-block mr-2' />
