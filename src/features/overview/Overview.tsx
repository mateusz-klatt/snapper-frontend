...
> = ({ loading, summary }) => {
  ...
  return <div className='text-center py-8 text-muted-600'>No positions data available</div>
}
...
> = ({ loading, signals }) => {
  ...
  return <div className='text-center py-8 text-muted-600'>No recent signals</div>
}
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <Card title='Recent Executions'>
          {recentExecutions.length > 0 ? (
            ...
            <div className='text-center py-8 text-muted-600'>No recent executions</div>
          )}
        </Card>
      </div>
    </div>
